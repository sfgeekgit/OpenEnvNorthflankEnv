...
REWARD_BUYER_SPEND_BELOW_MEDIAN = 2.0       # Total spend below median possible
PENALTY_BUYER_SPEND_ABOVE_2X = -2.0         # Total spend above 2x median possible
REWARD_BUYER_ZERO_FAILURES = 1.0            # Zero failures across all parts
...
NUM_SUPPLIERS = 5                           # Number of supplier agents
